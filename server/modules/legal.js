...
function privacy() {
  ...
  return shell("/privacy", "Privacy policy",
    ...
    [
      ...
      ["How we use it", `<ul><li>To make, manage and support your bookings and send confirmations.</li><li>To run your account and PlanurStay Rewards.</li><li>To send price alerts and newsletters you asked for. You can unsubscribe at any time.</li><li>To prevent fraud and keep the site secure.</li><li>To understand which pages and searches work well, so we can improve them.</li></ul>`],
